...
public class ModArmorTiers {
    ...
    public static final Holder<ArmorMaterial> SUPERITE_ARMOR_MATERIAL = register("superite", Util.make(new EnumMap<>(ArmorItem.Type.class),
            attribute -> {
            ...
            }), 18, 4f, 0.1f, () -> ModItems.SUPERITE.get());
